(() => {
    ...
    function initSliders() {
        bildSliders();
        if (document.querySelector(".swiper__container")) new core(".swiper__container", {
...
***************************************************************************** */
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        ...
        links.forEach((function(link) {
            link.addEventListener("click", (function(e) {
                ...
                links.forEach((function(link) {
                    link.classList.remove("_menu-target");
                }));
                this.classList.add("_menu-target");
        ...
        document.addEventListener("click", (function(e) {
            if (!e.target.closest("nav")) links.forEach((function(link) {
                link.classList.remove("_menu-target");
            }));
        }));
    }));
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        ...
        const targetBlock = document.getElementById("favourite");
        const targetOffset = targetBlock.offsetTop + 1034;
        window.addEventListener("scroll", (function() {
            if (window.pageYOffset >= targetOffset) {
                menu.classList.add("_active-menu-fixed");
                menu.classList.add("_active-menu-fixed-show");
            } else {
                menu.classList.remove("_active-menu-fixed");
                menu.classList.remove("_active-menu-fixed-show");
            }
        }));
    }));
